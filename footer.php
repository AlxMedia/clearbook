			...
			<div class="pad group">
				...
				<div class="grid one-full">
					...
					<div id="copyright">
						...
						<?php else: ?>
							<p><?php bloginfo(); ?> &copy; <?php echo esc_html( date_i18n( esc_html__( 'Y', 'clearbook' ) ) ); ?>. <?php esc_html_e( 'All Rights Reserved.', 'clearbook' ); ?></p>
						<?php endif; ?>
					</div><!--/#copyright-->
					
					<?php if ( get_theme_mod( 'credit', 'on' ) == 'on' ): ?>
					<div id="credit">
						<p><?php esc_html_e('Powered by','clearbook'); ?> <a href="<?php esc_url( _e( 'https://wordpress.org', 'clearbook' ) ); ?>" rel="nofollow">WordPress</a>. <?php esc_html_e('Theme by','clearbook'); ?> <a href="https://agnarson.com" rel="nofollow">Alx</a>.</p>
					</div><!--/#credit-->
					<?php endif; ?>
					
					<?php if ( get_theme_mod( 'footer-social', 'on' ) == 'on' ): ?>
						<?php clearbook_social_links() ; ?>
					<?php endif; ?>
